...
page 50108 "APILP - Sales Orders"
{
    APIGroup = 'LPCustom';
    APIPublisher = 'LP';
    ApplicationArea = All;
    Caption = 'LPSalesOrders';
    PageType = API;
    APIVersion = 'v2.0';
    ...
    DelayedInsert = true;
    EntityName = 'LPsalesOrder';
    EntitySetName = 'LPsalesOrders';
    ODataKeyFields = Id;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(LPsalesOrderLines; "APILP - Sales Order Lines")
                {
                    Caption = 'Lines';
                ...
                field(salesPoint; Rec."FJH.Sales Point")
                {
                    ...
                    trigger OnValidate()
                    begin
                        RegisterFieldSet(Rec.FieldNo("FJH.Sales Point"));
                    end;
                }
    ...
    local procedure GetAssemblyOrderID(Rec: Record "Sales Order Entity Buffer") AssemblyID: Guid
    var
    ...
    begin
        ...
        AssemblyLink.SetRange("Document No.", Rec."No.");

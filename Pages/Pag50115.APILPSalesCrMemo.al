...
page 50115 "APILP - Sales Cr. Memo"
{
    APIGroup = 'LPCustom';
    APIPublisher = 'LP';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'apilpSalesCrMemo';
    DelayedInsert = true;
    EntityName = 'LPsalesCreditMemo';
    EntitySetName = 'LPsalesCreditMemos';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(LPsalesCreditMemoLines; "APILP - Sales Credit Mem Lines")
                {
                    Caption = 'Lines';
                    EntityName = 'LPsalesCreditMemoLine';
                    EntitySetName = 'LPsalesCreditMemoLines';

...
page 50106 "APILP - Sales Invoices"
{
    APIGroup = 'LPCustom';
    APIPublisher = 'LP';
    ApplicationArea = All;
    ...
    DelayedInsert = true;
    EntityName = 'LPsalesInvoice';
    EntitySetName = 'LPsalesInvoices';
    ODataKeyFields = Id;
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                part(LPsalesInvoiceLines; "APILP - Sales Invoice Lines")
                {
                    Caption = 'Lines';
                    EntityName = 'LPsalesInvoiceLine';
                    EntitySetName = 'LPsalesInvoiceLines';
